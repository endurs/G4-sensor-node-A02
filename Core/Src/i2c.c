...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  */
    ...
    */
    ...
    /* I2C4 DMA Init */
    /* I2C4_RX Init */
    hdma_i2c4_rx.Instance = DMA1_Channel2;
    ...
    /* I2C4_TX Init */
    hdma_i2c4_tx.Instance = DMA1_Channel3;
    hdma_i2c4_tx.Init.Request = DMA_REQUEST_I2C4_TX;
    hdma_i2c4_tx.Init.Direction = DMA_MEMORY_TO_PERIPH;
    hdma_i2c4_tx.Init.PeriphInc = DMA_PINC_DISABLE;
    hdma_i2c4_tx.Init.MemInc = DMA_MINC_ENABLE;
    hdma_i2c4_tx.Init.PeriphDataAlignment = DMA_PDATAALIGN_HALFWORD;
    hdma_i2c4_tx.Init.MemDataAlignment = DMA_MDATAALIGN_HALFWORD;
    hdma_i2c4_tx.Init.Mode = DMA_CIRCULAR;
