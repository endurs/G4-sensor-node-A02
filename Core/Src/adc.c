...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PA1     ------> ADC1_IN2
    */
    GPIO_InitStruct.Pin = TC1_ADC_Pin|PT1_ADC_Pin;
  ...
  */
    ...
    PA7     ------> ADC2_IN4
    */
    GPIO_InitStruct.Pin = TC2_ADC_Pin|PT2_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  */
    ...
    PB13     ------> ADC3_IN5
    */
    GPIO_InitStruct.Pin = TC3_ADC_Pin|PT3_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  */
    ...
    PB15     ------> ADC4_IN5
    */
    GPIO_InitStruct.Pin = TC4_ADC_Pin|PT_ADC_Pin|IMON_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC1_IN2
    */
    HAL_GPIO_DeInit(GPIOA, TC1_ADC_Pin|PT1_ADC_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA7     ------> ADC2_IN4
    */
    HAL_GPIO_DeInit(GPIOA, TC2_ADC_Pin|PT2_ADC_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB13     ------> ADC3_IN5
    */
    HAL_GPIO_DeInit(GPIOB, TC3_ADC_Pin|PT3_ADC_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PB15     ------> ADC4_IN5
    */
    HAL_GPIO_DeInit(GPIOB, TC4_ADC_Pin|PT_ADC_Pin|IMON_ADC_Pin);
